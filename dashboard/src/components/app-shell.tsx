			...
			<SidebarFooter>
				...
				{authenticated ? (
					...
					<div className="text-muted-foreground px-2 text-sm">
						<LogIn className="mr-2 inline size-4" /> Sign in required
					</div>
				)}
			</SidebarFooter>
		</Sidebar>
...
export function AppShell({
	...
	return (
		<SidebarProvider>
			<AppSidebar authenticated={authenticated} onSignOut={onSignOut} />
			<SidebarInset>
			...
			<LoginDialog open={!authenticated} onAuthenticated={() => undefined} />
		</SidebarProvider>
	);
}
